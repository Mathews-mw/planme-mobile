...
class _EditTaskScreenState extends State<EditTaskScreen>
  ...
  void initState() {
    ...
    setState(() {
      ...
      if (widget.task.baseDateTime != null) {
        _pickedDate = DateTime(
          widget.task.baseDateTime!.year,
          widget.task.baseDateTime!.month,
          widget.task.baseDateTime!.day,
        );
      }
      if (widget.task.timeLabel != null) {
        _pickedTime = TimeOfDay(
          hour: widget.task.baseDateTime!.hour,
          minute: widget.task.baseDateTime!.minute,
        );
      }
    });
  }
